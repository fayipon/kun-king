...
function AppRoutes() {
  ...
  if (['/frontend','/promo','/my','/wallet','/affiliate','/play'].includes(pathname)) return <FrontendLayout>{pathname === '/affiliate' ? <Affiliate /> : pathname === '/wallet' ? <WalletPage /> : pathname === '/my' ? <My /> : pathname === '/promo' ? <Promo /> : pathname === '/frontend' ? <Landing /> : <main className="kk-main frontend-game"><Frontend /></main>}</FrontendLayout>
